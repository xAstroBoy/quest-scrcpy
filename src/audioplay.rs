...
//! then raw access units). We decode with the built-in Media Foundation AAC
//! decoder (no libopus/ffmpeg) and play through cpal, resampling to the output
//! device's rate as needed.
